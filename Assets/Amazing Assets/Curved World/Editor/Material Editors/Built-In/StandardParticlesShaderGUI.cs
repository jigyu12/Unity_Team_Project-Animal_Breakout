...
namespace AmazingAssets.CurvedWorld.Editor
{
    internal class StandardParticlesShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent[] blendNames = Array.ConvertAll(System.Enum.GetNames(typeof(BlendMode)), item => new GUIContent(item));
            ...
            public static GUIContent[] colorNames = Array.ConvertAll(System.Enum.GetNames(typeof(ColorMode)), item => new GUIContent(item));
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            MaterialProperties.InitCurvedWorldMaterialProperties(props);
        }
