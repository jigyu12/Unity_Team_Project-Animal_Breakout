...
void CurvedWorld_TwistedSpiral_X_Positive(inout float4 inVertexOS, float3 pivotPoint, float3 rotationAxis, float3 bendSize, float3 bendOffset)
{
    ...
    if (abs(dot(normalizedAxis, float3(1, 0, 0))) > 0.999)
    {
        ...
        {
            CurvedWorld_ClassicRunner_X_Negative(inVertexOS, pivotPoint, bendSize.yz, bendOffset.yz);
        }
    }
    else if (abs(dot(normalizedAxis, float3(0, 0, 1))) > 0.999)
    {
        ...
        {
            CurvedWorld_ClassicRunner_Z_Negative(inVertexOS, pivotPoint, bendSize.yz, bendOffset.yz);
        }
    }
    else
    {
...
void CurvedWorld_TwistedSpiral_X_Positive(inout float4 inVertexOS, inout float3 inNormalOS, float4 tangentOS, float3 pivotPoint, float3 rotationAxis, float3 bendSize, float3 bendOffset)
{
    ...
    if (abs(dot(normalizedAxis, float3(1, 0, 0))) > 0.999)
    {
        ...
        if (normalizedAxis.x > 0)
        {
            CurvedWorld_ClassicRunner_X_Positive(inVertexOS, inNormalOS, tangentOS, pivotPoint, bendSize.yz, bendOffset.yz);
        }
        else
        {
            CurvedWorld_ClassicRunner_X_Negative(inVertexOS, inNormalOS, tangentOS, pivotPoint, bendSize.yz, bendOffset.yz);
        }
    }
    else if (abs(dot(normalizedAxis, float3(0, 0, 1))) > 0.999)
    {
        ...
        if (normalizedAxis.z > 0)
        {
            CurvedWorld_ClassicRunner_Z_Positive(inVertexOS, inNormalOS, tangentOS, pivotPoint, bendSize.yz, bendOffset.yz);
        }
        else
        {
            CurvedWorld_ClassicRunner_Z_Negative(inVertexOS, inNormalOS, tangentOS, pivotPoint, bendSize.yz, bendOffset.yz);
        }
    }
    else
    {
